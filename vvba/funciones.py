...
def iniciarSesion():
    ...
    while True: 
        ...
        claveEncontrada = usuarios.leerCredenciales(usuario)
...
def crearUsuario():
    ...
    usuarios.crearUsuarioComun(nombre, username)
    contraseñaUsuario, listaEncriptacion = passlogic.ingresar_contraseña()
    usuarios.guardarCredenciales(username, contraseñaUsuario, listaEncriptacion)
